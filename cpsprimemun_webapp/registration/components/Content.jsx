        ...
        <div className="flex-[1] flex flex-col justify-start ">
          ...
          >
            ...
            >
              <p className={`${styles.paragraph} max-w-[312px] text-justify `}>
                <span className="text-black text-[18px]">
                  <p>CPS Prime MUN's dress code for the event is,</p>
                  <p className="mt-4 text-bold">08th July, 2023</p>
                  <p className="mt-0">Traditional Attire</p>
                  <p className="mt-4 text-bold">09th July, 2023</p>
                  <p className="mt-0">Western Business Attire</p>{" "}
                </span>
              </p>
            </div>
          </div>
